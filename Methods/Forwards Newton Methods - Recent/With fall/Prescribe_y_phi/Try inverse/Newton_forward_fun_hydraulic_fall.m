...
function [Phi,Xs,Ys,Xt,Yt,Theta,Theta_bottom,F] = Newton_forward_fun_hydraulic_fall(L,N,F_init_guess,amplitude,b_width,ijac,P,Theta_init_guess,Theta_b_init_guess)
...
%             save('JAC1.mat','jac1')
    ...
    for i = 1 : N - 1
        ...
        G(N:end-1)=Yt(1:end-1)- (amplitude*exp(-(b_width*Phi(1:end-1)).^2))';
