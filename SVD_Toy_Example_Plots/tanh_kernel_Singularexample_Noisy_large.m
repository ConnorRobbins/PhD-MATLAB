...
%%%%% Calculate/define h
h=M*f_orig;
noise_amp=1E-2; noise=noise_amp*2*(randn(N,1)-0.5); h_noise=h+noise;
...
if savefigures==1
    saveas(1,'tanh_kernel_noisy_large_truncation_plots.eps','epsc')
    saveas(1,'tanh_kernel_noisy_large_truncation_plots','fig')
    %
    saveas(2,'tanh_kernel_noisy_large_L_curve.eps','epsc')
    saveas(2,'tanh_kernel_noisy_large_L_curve','fig')
    %
    saveas(7,'tanh_kernel_noisy_large_DPC_plot.eps','epsc')
    saveas(7,'tanh_kernel_noisy_large_DPC_plot','fig')
    %
    saveas(9,'tanh_kernel_noisy_large_norm_rank_plot.eps','epsc')
    saveas(9,'tanh_kernel_noisy_large_norm_rank_plot','fig')
end
