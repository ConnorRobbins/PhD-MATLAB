...
%s=load('trapped_wave2_401points.mat'); L=s.L; Froude=s.Froude; P=s.P; Ys=s.Ys_Newton; Yt_orig=s.Yt_Newton; N_t=s.N; N_s=s.N;
%s=load('N1241trappedc3.mat'); L=s.L; Froude=s.Froude; P=s.P; Ys=s.Ys_Newton; Yt_orig=s.Yt_Newton; N_t=s.N; N_s=s.N;
%s=load('twice_as_noisy2.mat'); L=s.L; Froude=s.Froude; P=s.P; Ys=s.Ys_measurement; Yt_orig=s.Yt; N_t=s.N_t; N_s=s.N_s;
%s=load('forward_test_sub4.mat'); L=s.L; Froude=s.Froude; P=s.P; Ys=s.Ys_Newton; Yt_orig=s.Yt_Newton; N_t=s.N; N_s=s.N;
