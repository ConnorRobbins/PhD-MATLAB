...
rankSVD=550; %WILL BE OVERWRITTEN IF auto_pick_unperturbed_rank=1;   The fixed truncation rank for applying TSVD to the unperturbed problem BE OVERWRITTEN IF auto_pick_unperturbed_rank=1;   The fixed truncation rank for applying TSVD to the unperturbed problem
...
%middle extraction
[left_index_nonlinear,right_index_nonlinear]=FUN_middle_wave_extraction(Yt_nonlinear,Phi_t,surface_support);
...
%middle extraction
[left_index_kdv,right_index_kdv]=FUN_middle_wave_extraction(Yt_kdv,Phi_t,surface_support);
