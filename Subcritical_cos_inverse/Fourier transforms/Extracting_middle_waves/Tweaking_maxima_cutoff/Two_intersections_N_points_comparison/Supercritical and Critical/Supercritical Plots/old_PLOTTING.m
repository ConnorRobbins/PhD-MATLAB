...
plot(ks,log10(abs(amplitude*(2*(Froude-1) +(ks.^2)/3))),'-xb',DisplayName="kdv c1")
plot(ks,ones(size(ks))*log10(abs(3*(amplitude^2)/4)),'-xb',DisplayName="kdv c2")


%%% straight line between eneds
