clear
%kl,km,kr are the interesting wavelengths, put Nkpoints into each of the 4 intervals 
%total points are 4*Nkpoints +3 (kl,km,kr)
...
klm=(km-kl)/(Nkpoints+1);
kmr=(kr-km)/(Nkpoints+1);
...
wave_ks=[kl- klm*flip([0:Nkpoints]) , kl+klm*[1:Nkpoints],km+kmr*[0:Nkpoints] , kr+kmr*[0:Nkpoints]]; 
