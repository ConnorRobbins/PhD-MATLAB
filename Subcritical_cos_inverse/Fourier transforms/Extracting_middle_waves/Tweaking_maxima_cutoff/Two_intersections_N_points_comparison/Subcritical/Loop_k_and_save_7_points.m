...
klm=(km-kl)/2;
kmr=(kr-km)/2;
wave_ks=[kl-klm,kl,kl+klm,km,km+kmr,kr,kr+kmr];
...
rankSVD=90; %WILL BE OVERWRITTEN IF auto_pick_unperturbed_rank=1;   The fixed truncation rank for applying TSVD to the unperturbed problem BE OVERWRITTEN IF auto_pick_unperturbed_rank=1;   The fixed truncation rank for applying TSVD to the unperturbed problem
...
save(strcat(num2str(7),'K',num2str(wave_ki),'.mat'))
