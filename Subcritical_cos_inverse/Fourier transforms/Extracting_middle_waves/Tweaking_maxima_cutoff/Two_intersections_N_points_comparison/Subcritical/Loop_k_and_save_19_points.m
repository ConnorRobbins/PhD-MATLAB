...
klm=(km-kl)/5;
kmr=(kr-km)/5;
wave_ks=[kl-4*klm,kl-3*klm,kl-2*klm,kl-klm,kl,kl+klm,kl+2*klm,kl+3*klm,kl+4*klm,km,km+kmr,km+2*kmr,km+3*kmr,km+4*kmr,kr,kr+kmr,kr+2*kmr,kr+3*kmr,kr+4*kmr];
