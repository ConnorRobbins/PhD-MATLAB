...
rankSVD=26; %WILL BE OVERWRITTEN IF auto_pick_unperturbed_rank=1;   The fixed truncation rank for applying TSVD to the unperturbed problem
...
legendCell = strcat('k=',string(num2cell(wave_ks)));
...
for i=1:ks_number
    figure(10)
    plot(Phi_t,Yt_store(:,i),lines{i})
    figure(11)
    plot(Phi_s,Ys_store(:,i),lines{i})
end
