...
s=load('forced_solitary_a2E-2_F1p1_N641.mat','N','L','b_width','Froude','amplitude','Ys_Newton','Yt_Newton');
...
Ys=s.Ys_Newton;
Yt_true=reshape(s.Yt_Newton,N,1);

perturbation_N=10;  %how many different noise stds#
noise_amp=1E-2;
...
plot(Phi_t,Yt_from_averaged_Ys,'-b',LineWidth=2)%,DisplayName="$y_b$: averaging before")
