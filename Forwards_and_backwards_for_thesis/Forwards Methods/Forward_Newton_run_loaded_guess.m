...
N=641;
%filename='subcrit2bump341';
filename='subcritguess';
...
%forcings
%amplitude_left=s.amplitude_left; amplitude_right=s.amplitude_right; c_sep=s.c_sep; Yt=amplitude_right*exp(-(b_width*(Phi-c_sep)).^2) +amplitude_left*exp(-(b_width*(Phi+c_sep)).^2);
