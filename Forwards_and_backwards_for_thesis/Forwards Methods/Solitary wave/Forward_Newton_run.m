...
%loadguessname="unforced_solitary_guessN181";
loadguessname="unforced_solitary_F1p2_N481";
...
Theta_init_guess=load(loadguessname).Theta_Newton;
Phi_old=load(loadguessname).Phi;
