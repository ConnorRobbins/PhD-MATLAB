function [Phi,Xs,Ys,Xt,Yt,Theta,Theta_bottom,F] = Newton_forward_fun(L,N,F,ijac,P,Theta_init_guess,Theta_b_init_guess,Yt_true)
...
%             save('JAC1.mat','jac1')
    ...
    for i = 1 : N - 1
        ...
        G(N:end)=Yt(1:end-1)- Yt_true(1:end-1);
