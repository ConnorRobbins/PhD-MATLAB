...
load_for_init_guess=0;    guessfilename='guesstest2';   %
...
elseif load_for_init_guess==1
    s=load(guessfilename,'Theta_Newton','Theta_bottom_Newton','Phi');
    Theta_init_guess=interp1(s.Phi,s.Theta_Newton,Phi);
    Theta_b_init_guess=interp1(s.Phi,s.Theta_bottom_Newton,Phi);
    clearvars s
else
