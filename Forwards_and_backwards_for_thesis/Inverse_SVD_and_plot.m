...
loadname='supercritical_gaussian_bump_a2E-1_b1_F1p5';
%loadname='supercritical_2_gaussian_bump_a5E-2_b1';   %% DONT INCLUDE .mat
...
noise_amp=1E-5; noise=noise_amp*2*(randn(N_s,1))'; Ys=Ys+noise;
...
for k=1:maxrank
    ...
    Yt_minus_Yb_rank_k_difference_norm(k)=sqrt(trapz(Phi_t,(Yt-Yt_orig).^2 ));
...
try
    ...
    plot(Phi_t,Yt_example_2,'.-b',LineWidth=1,DisplayName=rankname_2)
end
